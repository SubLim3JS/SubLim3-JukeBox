...
$lang['settingsWifiSsidPlaceholder'] = "e.g.: Your-WiFi";
...
$lang['settingsMessageLangfileNewItems'] = "There are new language items in the original <em>lang-en-UK.php</em> file. Your language file has been updated and now contains these (in English). You might want to update your language file and commit your changes to the JukeBox code :)";
$lang['settingsWlanSendNav'] = "Mail Wlan IP";
$lang['settingsWlanSendInfo'] = "Send Wlan IP over email on boot? (useful if you hook your JukeBox into a new Wlan network with dynamic IP)";
...
$lang['settingsWlanReadInfo'] = "Read IP address of wlan (wifi) each time after booting? (useful if you hook your JukeBox into a new wlan network with dynamic IP)";
