...
$lang['globalEdition'] = "SubLim3 Edition";
...
$lang['cardRegisterManualLinks'] = "<p>You can also connect cards to folders manually. The manual explains how to <a href='https://github.com/SubLim3JS/SubLim3-JukeBox' target='–blank'>connect to the SubLim3 JukeBox</a> and <a href='https://github.com/MiczFlor/RPi-Jukebox-RFID/wiki/MANUAL#registering-cards-manually-through-samba-without-the-web-app' target='_blank'>register cards</a>.</p>";
...
$lang['settingsWifiSsidPlaceholder'] = "e.g.: Home WiFi";
...
$lang['settingsMessageLangfileNewItems'] = "There are new language items in the original <em>lang-en-UK.php</em> file. Your language file has been updated and now contains these (in English). You might want to update your language file and commit your changes to the SubLim3 JukeBox code :)";
$lang['settingsWlanSendNav'] = "Mail Wlan IP";
$lang['settingsWlanSendInfo'] = "Send Wlan IP over email on boot? (useful if you hook your SubLim3 JukeBox into a new Wlan network with dynamic IP)";
...
$lang['settingsWlanReadInfo'] = "Read IP address of wlan (wifi) each time after booting? (useful if you hook your SubLim3 JukeBox into a new wlan network with dynamic IP)";
